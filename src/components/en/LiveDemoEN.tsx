...
const demoSteps = [
    {
        ...
        description: "Create your free account with just your email. No credit card, no commitments.",
        image: "/tutorial/2_register.png",
        highlight: "⚡ Just 30 seconds"
    },
    {
        id: 2,
        title: "2. Log in",
        description: "Access your control panel with Creatiendas branding - simple and professional.",
        image: "/tutorial/3_login.png",
        highlight: "🔐 Secure access"
    },
    {
        id: 3,
        title: "3. Build your store",
        description: "Use our visual builder. Add name, description, WhatsApp, products and images.",
        image: "/tutorial/4_builder.png",
        highlight: "🛠️ Drag & drop builder"
    },
    {
        id: 4,
        title: "4. Manage your stores",
        description: "See all your stores in one place. Edit, update and manage from your dashboard.",
        image: "/tutorial/5_dashboard.png",
        highlight: "📊 Control panel"
    },
    {
        id: 5,
        title: "5. Your store is ready!",
        description: "Share the link with your customers. Receive orders directly to your WhatsApp.",
        image: "/tutorial/6_store.png",
        highlight: "🚀 Live in 2 minutes!"
    }
];
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                        ...
                        <div className="lg:col-span-1 space-y-4">
                            ...
                            <div className="pt-6 flex items-center justify-center lg:justify-start gap-3 border-t border-gray-100 mt-4">
                                ...
                                <span className="text-xs font-black text-gray-400 uppercase tracking-widest">Auto-play</span>
                            </div>
                        </div>
                            ...
                            <div className="relative group overflow-hidden rounded-[2rem] border-4 border-gray-800 shadow-2xl">
                                ...
                                <div className="bg-gray-800 p-4 flex items-center gap-2">
                                    ...
                                    <div className="flex-1 bg-gray-700/50 rounded-lg px-4 py-1.5 text-gray-400 text-[10px] font-mono text-center mx-4">
                                        https://creatiendas.com/my-store
                                    </div>
                                </div>
