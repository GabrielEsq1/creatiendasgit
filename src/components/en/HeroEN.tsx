            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                <div className="flex justify-center mb-10">
                    ...
                    >
                        ...
                        <div className="text-left">
                            <p className="text-[10px] uppercase font-black text-amber-900 tracking-widest leading-none mb-1">Limited Slots</p>
                            <p className="text-sm font-black text-amber-900">Schedule your FREE Onboarding</p>
                        </div>
                ...
                <div className="text-center max-w-5xl mx-auto mb-16">
                    <h1 className="text-5xl md:text-7xl lg:text-8xl font-black tracking-tight mb-8 leading-[1.1] text-white">
                        The <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-emerald-500">Shopify</span>
                        <br />
                        <span className="text-white">for <span className="text-green-500 underline decoration-green-500/30 decoration-8 underline-offset-8">WhatsApp</span> 🎄</span>
                    </h1>
                    <p className="text-xl md:text-2xl text-slate-400 max-w-3xl mx-auto leading-relaxed font-medium">
                        Create your online store in <span className="text-white font-bold">2 minutes ❄️</span>.
                        Your customers order via WhatsApp with zero friction. <br className="hidden md:block" />
                        <span className="text-green-400 font-extrabold bg-green-500/10 border border-green-500/20 px-3 py-1 rounded-lg">🎁 0% COMMISSIONS. 100% FREE.</span>
                    </p>
                </div>
                                ...
                                <table className="w-full text-left border-collapse min-w-[600px] sm:min-w-0">
                                    ...
                                    <tbody className="divide-y divide-slate-800">
                                        <tr className="group hover:bg-slate-800/50 transition-colors">
                                            <td className="p-3 sm:p-4 md:p-6 lg:p-8 font-bold text-xs sm:text-sm md:text-base text-slate-300">Monthly Price</td>
                                            <td className="p-3 sm:p-4 md:p-6 lg:p-8 text-center text-rose-500 font-extrabold text-xs sm:text-sm md:text-base">$29+ USD</td>
                                            <td className="p-3 sm:p-4 md:p-6 lg:p-8 text-center text-green-400 font-black bg-green-500/5 text-xs sm:text-sm md:text-base">FREE! 🎅</td>
                                        </tr>
                                        <tr className="group hover:bg-slate-800/50 transition-colors">
                                            <td className="p-3 sm:p-4 md:p-6 lg:p-8 font-bold text-xs sm:text-sm md:text-base text-slate-300">Setup Time</td>
                                            ...
                                            <td className="p-3 sm:p-4 md:p-6 lg:p-8 text-center text-green-400 font-black bg-green-500/5 text-xs sm:text-sm md:text-base">2 minutes ⚡</td>
                                        </tr>
                                        <tr className="group hover:bg-slate-800/50 transition-colors">
                                            <td className="p-3 sm:p-4 md:p-6 lg:p-8 font-bold text-xs sm:text-sm md:text-base text-slate-300">Native WhatsApp</td>
                                            ...
                                            <td className="p-3 sm:p-4 md:p-6 lg:p-8 text-center text-green-400 font-black bg-green-500/5">
                                                <div className="flex items-center justify-center gap-1 sm:gap-2 font-black text-xs sm:text-sm md:text-base">
                                                    <span className="text-lg sm:text-xl">✅</span> Integrated ❄️
                                                </div>
                                            </td>
                                        </tr>
                                    </tbody>
