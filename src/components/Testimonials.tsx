            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="columns-1 md:columns-2 lg:columns-3 gap-6 space-y-6">
                    {testimonials.map((t, idx) => (
                        <div
                            key={idx}
                            className="break-inside-avoid bg-white border border-slate-100 rounded-[2rem] p-8 flex flex-col shadow-lg shadow-slate-200/50 hover:border-green-500/30 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group"
                        >
                            <div className="mb-4">
                                <span className="inline-block bg-slate-100 text-slate-500 text-[10px] font-bold px-2 py-1 rounded-lg uppercase tracking-wider group-hover:bg-green-50 group-hover:text-green-600 transition-colors">
                                    {t.tag}
                                </span>
                            </div>
                            <p className="text-slate-600 italic mb-6 text-base md:text-lg leading-relaxed">
                                "{t.quote}"
                            </p>
                            <div className="mt-auto flex items-center gap-3 pt-6 border-t border-slate-50">
                                ...
                                <div>
                                    ...
                                    <p className="text-slate-400 text-xs font-bold uppercase tracking-wider">{t.role}</p>
                                </div>
                            </div>
                        </div>
                    ))}
