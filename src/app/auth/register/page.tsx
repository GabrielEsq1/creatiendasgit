                        ...
                        <div className="mb-6 bg-white rounded-[2rem] p-6 shadow-lg border border-slate-100 relative overflow-hidden group">
                            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 relative z-10">
                                ...
                                <div className="flex-1 min-w-0">
                                    <p className="text-slate-900 font-black text-base sm:text-lg mb-1">¿Tienes alguna duda?</p>
                                    <p className="text-slate-500 text-xs sm:text-sm mb-3 font-medium">Escríbeme y te ayudo en menos de 1 minuto</p>
                                    <a
