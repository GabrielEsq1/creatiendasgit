            ...
            <div className="container mx-auto px-4 py-8">
                <div className="grid lg:grid-cols-2 gap-12 items-center max-w-7xl mx-auto">
                    ...
                    <div className="order-1 lg:order-2">
                        ...
                        <div className="mb-6 bg-gradient-to-r from-green-500 to-emerald-600 rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-xl shadow-green-500/30 border-2 border-green-400">
                            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4">
                                ...
                                <div className="flex-1 min-w-0">
                                    <p className="text-white font-bold text-base sm:text-lg mb-1">¿Tienes alguna duda?</p>
                                    <p className="text-green-50 text-xs sm:text-sm mb-3">Escríbeme y te ayudo en menos de 1 minuto 👋</p>
                                    <a
                                        href="https://wa.me/573026687991?text=Hola!%20Tengo%20una%20duda%20sobre%20c%C3%B3mo%20crear%20mi%20tienda"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="inline-flex items-center gap-2 bg-white text-green-600 font-bold px-4 sm:px-5 py-2.5 sm:py-3 rounded-lg sm:rounded-xl hover:bg-green-50 transition-all transform hover:scale-105 active:scale-95 shadow-lg text-sm sm:text-base min-h-[44px]"
                                    >
                        ...
                        <div className="bg-white rounded-2xl sm:rounded-3xl shadow-2xl border border-gray-100 p-6 sm:p-8 md:p-10">
                            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Crear cuenta gratis</h2>
                            <p className="text-sm sm:text-base text-gray-600 mb-6 sm:mb-8">Tu tienda estará lista en el siguiente paso</p>
                            ...
                            <form onSubmit={handleRegister} className="space-y-5">
                                ...
                                <button
                                    type="submit"
                                    disabled={loading}
                                    className="w-full bg-green-500 hover:bg-green-600 text-white font-bold py-3.5 sm:py-4 rounded-xl transition-all transform hover:scale-[1.02] active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2 shadow-xl shadow-green-500/30 text-base sm:text-lg min-h-[48px]"
                                >
                                    {loading ? (
