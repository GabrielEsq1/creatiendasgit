...
export const metadata: Metadata = {
    ...
    description: "Crea tu tienda online gratis hoy. Sin comisiones, sin pagos mensuales. Elige tu nombre, sube productos y vende por WhatsApp de inmediato.",
};
    ...
    return (
        <>
            <BreadcrumbSchema
                items={[
                    { name: 'Inicio', item: '/' },
                    { name: 'Crear Tienda Online Gratis', item: '/crear-tienda-online-gratis' }
                ]}
            />
            <ArticleLayout
                title="Cómo crear una tienda online GRATIS en 2 minutos (sin comisiones)"
