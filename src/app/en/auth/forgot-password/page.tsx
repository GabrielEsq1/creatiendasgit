...
export default function ForgotPasswordPageEN() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (res.ok) {
                setStatus("success");
                setMessage("We have sent the instructions to your email.");
                if (data.debugLink) {
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 flex items-center justify-center p-4">
            <div className="w-full max-w-[420px] bg-white/80 backdrop-blur-xl rounded-[2rem] shadow-2xl border border-white/50 p-8 sm:p-10 relative overflow-hidden">
                ...
                <div className="relative z-10 mb-6">
                    <Link href="/en/auth/login" className="inline-flex items-center text-sm font-medium text-slate-500 hover:text-slate-800 transition-colors">
                ...
                <div className="text-center mb-8 relative z-10">
                    ...
                    <h2 className="text-2xl font-bold text-slate-800 mb-2">Recover Password</h2>
                ...
                <form className="space-y-4" onSubmit={handleSubmit}>
                    ...
                    {debugLink && (
                        <div className="p-3 bg-yellow-50 border border-yellow-100 rounded-lg text-xs text-yellow-800 break-all animate-in fade-in">
                            <p className="font-bold mb-1">Debug Mode:</p>
