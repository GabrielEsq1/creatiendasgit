    ...
    const handleRegister = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                // Translate basic errors if possible, or display generic
                    ...
                    <div className="space-y-8 order-2 lg:order-1">
                        ...
                        <div>
                            <h1 className="text-4xl md:text-5xl font-black text-white mb-4 leading-tight">
                                Create your online store in <span className="text-green-400">less than 2 minutes</span>
                            </h1>
                            <p className="text-xl text-slate-400 leading-relaxed">
                                In the next step your store will be ready to share via WhatsApp. <strong className="text-white">No card needed. ❄️</strong>
                            </p>
                        </div>
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-start gap-3">
                                <span className="text-2xl">⚡</span>
                                <div>
                                    <strong className="text-white text-lg font-bold">Publish products in minutes</strong>
                                    <p className="text-slate-400">No complicated settings</p>
                                </div>
                            </li>
                            <li className="flex items-start gap-3">
                                <span className="text-2xl">📲</span>
                                <div>
                                    <strong className="text-white text-lg font-bold">Receive orders via WhatsApp</strong>
                                    <p className="text-slate-400">Connect directly with your customers</p>
                                </div>
                            </li>
                            <li className="flex items-start gap-3">
                                <span className="text-2xl">💰</span>
                                <div>
                                    <strong className="text-white text-lg font-bold">0% commissions</strong>
                                    <p className="text-slate-400">All the money is yours</p>
                                </div>
                            </li>
                        </ul>
                        ...
                        <div className="mb-6 bg-slate-900/50 backdrop-blur-xl rounded-[2rem] p-6 shadow-2xl border-2 border-white/5 relative overflow-hidden group">
                            ...
                            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 relative z-10">
                                <div className="flex-shrink-0">
                                    ...
                                    <div>
                                        <p className="text-white font-black text-base sm:text-lg mb-1">Have any questions? 🎅</p>
                                        <p className="text-slate-400 text-xs sm:text-sm mb-3 font-medium">Write me and I'll help you in less than 1 minute 👋</p>
                                        <a
                            ...
                            <div className="bg-slate-900/80 backdrop-blur-3xl rounded-[2.5rem] shadow-2xl border border-white/10 p-8 md:p-10 relative overflow-hidden group/form hover:border-green-500/30 transition-all duration-500">
                                ...
                                <h2 className="text-3xl font-black text-white mb-2 relative z-10">Create <span className="text-green-400">free</span> account 🎁</h2>
                                <p className="text-sm sm:text-base text-slate-400 mb-8 font-medium">Your store will be ready in the next step ❄️</p>
                                ...
                                <div className="relative my-10">
                                    ...
                                    <div className="relative flex justify-center text-sm">
                                        <span className="px-4 bg-slate-900 text-slate-500 font-bold uppercase tracking-widest">Already have an account?</span>
                                    </div>
                                </div>
