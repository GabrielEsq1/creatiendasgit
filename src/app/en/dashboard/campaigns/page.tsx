...
export default function UserCampaignsPageEN() {
                ...
                <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    {campaigns.length === 0 ? (
                        <div className="p-12 text-center">
                            ...
                            <h3 className="text-lg font-medium text-gray-900 mb-2">You have no campaigns</h3>
                            <p className="text-gray-600 mb-6">Create your first campaign to start</p>
                            <button
                                onClick={() => setShowCreateForm(true)}
