  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6 grid gap-6 font-sans">
      <div className="text-center mb-8">
        <h1 className="text-4xl font-black mb-2 text-gray-900">B2BChat + CreaTiendas</h1>
        <p className="text-gray-600 text-lg font-medium">Comunicación B2B y tiendas en un solo ecosistema.</p>
      </div>
